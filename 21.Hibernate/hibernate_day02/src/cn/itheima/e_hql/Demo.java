...
//		String hql = " from cn.itheima.domain.Customer ";
		String hql = " from Customer "; // 查询所有Customer对象，在所有的包下只有一个Customer类，就用这个
		//2> 根据HQL语句创建查询对象
	...
	@Test
	//条件查询
	//命名占位符：有点事有可能表的列位置会发生变化，所以直接名字就好了
	public void fun4(){
		//1 获得session
		Session session = HibernateUtils.openSession();
		//2 控制事务
		...
		//3执行操作
		//-------------------------------------------
		//1> 书写HQL语句 hibernate遇到这个冒号就知道是占位符了，后面不能有空格
