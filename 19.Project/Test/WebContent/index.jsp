...
<head>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	$(document).ready(function(){
		...
		$.get("${pageContext.request.contextPath}/ajaxTest",{"username":username},function(info){
				sonDiv.html(info);
				mydiv.append(sonDiv);	
			});
...
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="${pageContext.request.contextPath}/showAllTie" target="right"><span class="icon-caret-right"></span>留言管理</a></li>     
  </ul>    
</div>
<script type="text/javascript">
$(function(){
