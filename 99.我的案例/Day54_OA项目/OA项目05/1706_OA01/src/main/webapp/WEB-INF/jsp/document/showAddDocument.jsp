...
<form class="layui-form" id="uploadForm">
    ...
    <div class="layui-form-item" style="margin-top: 5px">
        ...
        <div class="layui-input-block" style="margin-right: 50px">
            <textarea type="text" class="form-control" placeholder="请简单描述文件" rows="5" cols="10" name="remark" id="remark"></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item" style="margin-top: 5px">
        ...
        <div class="layui-input-inline">
            <button type="button" class="btn-success btn" id="upload">
    ...
    layui.use(['form', 'layer', 'upload'], function () {
        ...
        var uploadInit = upload.render({
            ...
            before: function () {
                ...
                uploadInit.config.data.uid = ${user_session.id};
            },
            done: function (res) {
                if (res.code == 1) {
