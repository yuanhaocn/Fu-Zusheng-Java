...
<head>
    ...
    <![endif]-->
    <title>Mall商城后台管理系统 v1.0</title>
    <meta name="keywords" content="Mall商城后台管理系统 v1.0,Mall,Mall购物商城后台管理系统">
    <meta name="description" content="Mall商城后台管理系统 v1.0，是一款电商后台管理系统，适合中小型CMS后台系统。">
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">Mall商城后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/">H-ui</a>
                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onclick="product_add('添加商品','product-add','','600')"><i class="Hui-iconfont">&#xe620;</i> 商品</a></li>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li id="Hui-msg"> <a onclick="thanks()" title="消息"><span class="badge badge-danger">1</span><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i></a> </li>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2" style="display:none">
        ...
        <dl id="menu-b">
            ...
            <dd>
                <ul>
                    <li><a data-href="thanks-list" data-title="财务报表" href="javascript:void(0)">财务报表</a></li>
                </ul>
            </dd>
        </dl>
    </div>
