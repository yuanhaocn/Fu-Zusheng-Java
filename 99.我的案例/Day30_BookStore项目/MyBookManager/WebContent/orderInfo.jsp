							...
							<td>
								<table width="100%" border="0" cellspacing="0">
									...
									<tr>
									   ...
									   <c:forEach items="${order.orderItems }" var="info" varStatus="vs">
											<table width="100%" border="0" cellspacing="0">
												<tr>
													<td width="10%">${vs.count }</td>
													<td width="40%">${info.book.name }</td>
													<td width="10%">${info.book.price }</td>
													<td width="10%">${info.buynum }</td>
													<td width="10%">${info.buynum*info.book.price }</td>
