...
<section id="container" >
                        ...
                        <div class="panel-body">
                            <div class="tab-content tasi-tab">
                                <div class="tab-pane active" id="popular">
                                    <article class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p><br>Mall商城是基于SOA架构的大型开源分布式电商B2C购物商城，前后端开发分离，前台
                                                基于Vue全家桶开发，前台商城演示地址：<a href="#">点我查看</a><br><br>
                                ...
                                <div class="tab-pane " id="recent">
                                    <div style="text-align: center"><h2>Mall商城</h2></div>
                                    <div style="text-align: center">
                                       <p>分布式系统（distributed system）是建立在网络之上的软件系统。正是因为软件的特性，所以分布式系统具有高度的内聚性和透明性。因此，网络和分布式系统之间的区别更多的在于高层软件（特别是操作系统），而不是硬件。内聚性是指每一个数据库分布节点高度自治，有本地的数据库管理系统。透明性是指每一个数据库分布节点对用户的应用来说都是透明的，看不出是本地还是远程。在分布式数据库系统中，用户感觉不到数据是分布的，即用户不须知道关系是否分割、有无副本、数据存于哪个站点以及事务在哪个站点上执行等。</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <div class="text-center mbot30">
                                <h3 class="timeline-title">Mall更新日志</h3>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p><a href="#">yyg</a> 完成目前所有功能开发 <span><a href="#" class="green">v1.0发布</a></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </article>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p><a href="#" target="_blank">yyg</a> 完成后端接口改造二次开发 <span><a class="blue" href="#">Mall-Front</a></span></p>
                                                <div class="album">
                                                    <a href="#">
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p>
                                                    感谢 <a href="#">yyg</a> 的开源
                                                    <a href="#">vue-mall</a> 项目提供前端页面及框架支持
                                                </p>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <p><a href="#">yyg</a> 启动了
                                                    <span><a href="#"  class="light-green">Mall</a></span>
                                                    项目，并完成第一次提交</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <footer class="social-footer">
                                        <ul>
                                            ...
                                            <li class="active">
                                                <a  href="http://wpa.qq.com/msgrd?v=3&uin=2211119590&site=qq&menu=yes">
    ...
    <footer class="site-footer">
        <div class="text-center">
            Copyright &copy;2017 <a href="#">yiyige.cn</a> All Rights Reserved.
            <a href="#" class="go-top">
