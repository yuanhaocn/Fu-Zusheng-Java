...
public class LuceneUtil {
	...
	/**
	 * 利用IKAnalyzer分词器获取IndexWriter对象
	 */
	public static IndexWriter createIndexWriterByIK() throws IOException {
		IndexWriterConfig config = new IndexWriterConfig(getVersion(), new IKAnalyzer());
		return new IndexWriter(getDirectory(), config);
	}
