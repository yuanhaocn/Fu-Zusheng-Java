...
<head>
    ...
    <meta name="keywords" content="Mall商城后台管理系统 v1.0,Mall商城,Mall商城购物商城后台管理系统">
...
<div data-vide-bg="lib/video/Ipad">
    <div class="center-container">
        ...
        <div class="header-w3l">
            <h1>Mall<span class="title">商城后台管理系统</span></h1>
        </div>
        <!--//header-->
        ...
        <!--footer-->
        <div class="footer">
            <p>&copy; 2017 Mall商城. All rights reserved | Design by <a href="#">YYG</a></p>
        </div>
        <!--//footer-->
    </div>
</div>
