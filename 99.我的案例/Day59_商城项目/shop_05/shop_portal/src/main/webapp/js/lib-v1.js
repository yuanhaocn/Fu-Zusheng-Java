...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		//URL_Serv: "http://localhost:8082/category.js",
		//URL_Serv: "http://localhost:8083/category.js",
       ...
       /* var a, b = {}, c = $("#categorys-2013");
    	...
    	console.log("url="+this.URL_Serv);
    	
    	//使用jsonp来实现跨域请求：特点：被请求的必须返回js代码，js代码会立刻被执行
    	//域名不同或者端口不同都不能访问，只有域名和端口都相同才能访问
    	//第二个参数传递的是函数名，这个函数使用来解析json数据的
      ...
      //  $.getJSONP(this.URL_BrandsServ, category.getBrandService)
    },getDataService: function(a) {//回调函数
        var b = [], c = this;
