 ...
 * generated in the com.syc.ws.client01 package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://ws.syc.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://ws.syc.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.syc.ws.client01
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.syc.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.syc.com/", name = "queryWeatherResponse")
