  ...
  <div class="body-content">
   <form action="${pageContext.request.contextPath}/photoUploadServlet" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
	<hr>
		<input type="text" id="url1" name="img" class="input tips" style="width:10%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input  type="submit" value="提交" name="upbtn">  
        </div>
      </div>
    </form>
	<hr>
