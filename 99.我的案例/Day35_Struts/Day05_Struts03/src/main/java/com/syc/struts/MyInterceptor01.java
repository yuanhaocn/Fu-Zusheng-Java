...
public class MyInterceptor01 implements Interceptor {
	...
	// 通常在该方法中进行一些初始化的操作.
	public void init() {
		System.out.println("MyInterceptor01---->init()方法结束执行了...");
	}
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		...
		System.out.println("MyInterceptor01---->intercept()方法开始执行了...");
		...
		System.out.println("01---invoke="+invoke);

		System.out.println("MyInterceptor01---->intercept()方法结束执行了...");
	...
	// 通常在该方法中释放一些资源.
	public void destroy() {
		System.out.println("MyInterceptor01---->destroy()方法结束执行了...");
	}
