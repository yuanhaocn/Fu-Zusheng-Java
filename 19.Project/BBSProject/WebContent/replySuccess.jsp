	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="jumbotron" style="font-size: 20px;">
				<div>
					<font style="font-size: 30px;"><i class="icon-spinner icon-spin"></i></font>回复成功！5秒后跳转...
				</div>
				<div>
					您也可以直接点击<a href="viewTie?sendTieId=${sendTieId }"><font style="font-size: 24px;"><i class="icon-reply"></i>返回</a></font>
				</div>
			</div>
		</div>
		<div class="col-md-3"></div>
